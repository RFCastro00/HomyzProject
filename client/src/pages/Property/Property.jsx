...
const Property = () => {
  ...
  const {mutate: cancelBooking, isLoading: cancelling} = useMutation({
    ...
    onSuccess: ()=> {
      ...
      toast.success("Your booking has been cancelled", {position: 'bottom-right'});
    }
  });
  ...
  return (
    <div className="wrapper">
      <div className="flexColStart paddings innerWidth property-container">
        ...
        {/*image*/}
        <img src={data.image} alt="home image" className="src" />
          ...
          <div className="flexColStart left">
            ...
            {/* Book visit button */}
            {
              bookings?.map((bookings)=> bookings.id).includes(id) ? (
                ...
                <span>
                  Your visit has already booked for this date {bookings?.filter((booking)=> booking?.id === id)[0].date}
                </span>
                </>
              ) : (
              <button 
